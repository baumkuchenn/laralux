            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{ url('product') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan Maksimal Orang Kamar di Kamar"
                            name="jumlahIsi">
                        <span class="help-block">
                            Masukkan maksimal orang di kamar. </span>
                        <label for="harga">Harga per Malam</label>
                        <input type="text" class="form-control" placeholder="Masukkan Harga per Malam Kamar"
                            name="harga">
                        <span class="help-block">
                            Masukkan Harga per Malam Kamar. </span>
                        <label for="jumlahAvail">Jumlah Kamar Kosong</label>
                        <input type="text" class="form-control" placeholder="Masukkan Jumlah Kamar Kosong"
                            name="jumlahAvail">
                        <span class="help-block">
