    ...
    <div class="portlet-body form">
        <form method="POST" action="{{ route('hotel.update', $data->id) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputType" name="hotel_name" aria-describedby="nameHelp" placeholder="Masukkan Nama Hotel..." value="{{$data->nama}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputType" name="hotel_address" aria-describedby="nameHelp" placeholder="Masukkan Alamat Hotel..." value="{{$data->alamat}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputType" name="hotel_phone" aria-describedby="nameHelp" placeholder="Masukkan Nomer Telepon Hotel..." value="{{$data->no_telpon}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputType" name="hotel_email" aria-describedby="nameHelp" placeholder="Masukkan Email Hotel..." value="{{$data->email}}">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="hotel_id" name="hotel_type">
                    @foreach ($types as $t)
                    <option @if ($data->hoteltype_id==$t->id)
                        selected
                        @endif
